package com.solvd.thebuildingcompany.employees.abstractclass;
...
public abstract class Employees {
    ...
    public Employees(String firstName, String lastName, int employeeID, int departmentID, Date hireDate, int paymentPerHour) {
    ...
    public Employees(String firstName, String lastName, String email, int phoneNumber, String homeStreetAddress,
    ...
    public Employees(String firstName, String lastName, double paymentPerHour, double hoursWorked){
        this.firstName = firstName;
        this.lastName = lastName;
        this.paymentPerHour = paymentPerHour;
